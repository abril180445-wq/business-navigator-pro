  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="pbi-tile max-w-md w-full text-center p-10">
        ...
        <h2 className="text-lg font-bold" style={{ color: "hsl(var(--pbi-text-primary))" }}>{name}</h2>
        <p className="text-[12px] mt-2" style={{ color: "hsl(var(--pbi-text-secondary))" }}>
          Este módulo está em desenvolvimento. Em breve você terá acesso completo a todas as funcionalidades.
        </p>
        <div className="mt-4 h-1.5 rounded-full overflow-hidden" style={{ background: "hsl(var(--pbi-border))" }}>
          <div className="h-full rounded-full w-1/3" style={{ background: "hsl(var(--pbi-yellow))" }} />
        </div>
        <p className="text-[10px] mt-2" style={{ color: "hsl(var(--pbi-text-secondary))" }}>Em progresso...</p>
      </div>
    </div>
  );
}
